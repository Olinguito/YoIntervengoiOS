...
class DataService {
    ...
    func initializeData(){
        if !NSUserDefaults.standardUserDefaults().boolForKey("dataInitialized") {
            ...
            category21.icon = "btn_reporte_buildings"
            category21.id   = 1
            ...
            category22.icon = "btn_reporte_environment"
            category22.id   = 1
            ...
            category23.icon = "btn_reporte_more"
            category23.id   = 1
            ...
            category24.icon = "btn_reporte_security"
            category24.id   = 1
            ...
            category25.icon = "btn_reporte_buildings"
            category25.id   = 1
            ...
            category26.icon = "btn_reporte_mobility"
            category26.id   = 1
