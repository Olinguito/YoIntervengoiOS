...
#define CALLOUT_DEFAULT_HEIGHT 108 // fixed height of system callout; ours can be any height when contentView is set
#define CALLOUT_DEFAULT_CONTAINER_HEIGHT 108 // height of just the main portion without arrow
